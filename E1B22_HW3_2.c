...
void printMainMenu() {
    ...
    printf("|fkufehhsehfshehseh                     |\n");
    printf("|                  djsndjjfdjvjnfrgjnfej|\n");
    printf("|              bdgcjysabdjadbwj         |\n");
    printf("|                                       |\n");
    printf("|                                       |\n");
    ...
    printf("|        d. Exit                        |\n");
    printf("|                                       |\n");
    printf("|             gsrfbjsrvhbjshfgseyjg     |\n");
    printf("|                    fehuehefduhswuyegfk|\n");
    printf("|                 E1B22                 |\n");
    printf("+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+\n");//個人風格主選單 
}
...
//第一次皆可正常執行， 第二次進行個人風格畫面之修改。 
//心得二：終於弄懂Git的操作程序了，其實只要能上手，將來在職場上一定能很順利。 
